...
public class OServiceInstanceListDPage extends DPage implements IGridDataSource<OServiceInstance> {
	...
	protected void onInitialize() {
		...
		columnList.add(new OPropertyColumn<OServiceInstance>(new ResourceModel("OServiceInstance.name"), "name"));
		...
		columnList.add(new OAjaxLinkColumn<OServiceInstance>(new Model<String>(), AresIcon.EDIT) {
			private static final long serialVersionUID = -742785953L;
