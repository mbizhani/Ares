...
public class CommandLogListDPage extends DPage implements IGridDataSource<CommandLog> {
	...
	protected void onInitialize() {
		...
		floatTable.add(new WTextInput("param")
			.setLabel(new ResourceModel("CommandLog.param")));
		...
		columnList.add(new OPropertyColumn<CommandLog>(new ResourceModel("CommandLog.param"), "param"));
